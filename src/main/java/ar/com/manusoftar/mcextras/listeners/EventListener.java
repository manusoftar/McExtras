...
public class EventListener implements Listener {
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (heldItem.getType() == Material.MAP && heldItem.hasItemMeta() && heldItem.getItemMeta().hasDisplayName()) {
            ...
            StructureType tipo = utils.getTypeFromKeys(meta);
            if (tipo != null) {
                ...
                generateTreasureMap(player, tipo);
                
            }
        }
    }

    private void generateTreasureMap(Player player, StructureType st) {
            String playerLocale = player.locale().toString();
            ...
            // StructureSearchResult resultado = mundoSurvival.locateNearestStructure(startLocation, st, 300, true);
            // if (resultado == null) {
            ...
            // Volver al hilo principal para crear y dar el mapa
                ...
                //if (treasureLocation != null) {
                    ...
                    ItemStack treasureMap = Bukkit.getServer().createExplorerMap(mundoSurvival, startLocation, st, mapIcon, 300, true);
